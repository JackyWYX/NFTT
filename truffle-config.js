...
const fs = require('fs');
const PRIFILE = "./.pri.json";
const privateKeys = fs.existsSync(PRIFILE) ? require(PRIFILE) : "";
/**
...
module.exports = {
  ...
  networks: {
    ...
    ok_main: {
      provider: () => new HDWalletProvider([privateKeys], `https://exchainrpc.okex.org`),
    ...
    hmy_main: {
      provider: () => new HDWalletProvider([privateKeys], "https://api.s0.t.hmny.io"),
      network_id: '1666600000',       // Any network (default: none)
      skipDryRun: true,
    },
    fdr_test: {
      provider: () => new HDWalletProvider([privateKeys], "https://dev-evm.dev.findora.org:8545"),
